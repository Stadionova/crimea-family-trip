...
const textDataDesc = {
    1: {
        ...
        2: [
            `В окрестностях Бахчисарая находится несколько пещерных городов, мы посетили два из них. 
            Сначала мы погуляли по Чуфут-Кале, поскольку он располагается в пешей доступности 
            от того места, где мы поселились. В пещерный город мы отправились рано утром к открытию, 
            чтобы спокойно полазить по сооружениям и не спеша всё осмотреть. Мы были под впечатлением от увиденного и 
            решили преодолеть 8 километров пешком, чтобы увидеть ещё один пещерный город – Качи-Кальон.`,
            `После 11-дневного похода нам не составило труда до него добраться, хотя народ явно предпочитает туда ездить на 
            автотранспорте. Стоит ли прилагать такие усилия, чтобы посмотреть ещё один пещерный город? 
            Ответ будет – да. Если есть время, то лучше отправиться сюда на следующий день, 
            чтобы никуда не спешить и насладиться прогулкой, в которой приходилось большую часть времени не просто ходить, 
            а лазить.`,
        ],
        3: [
            `Существует два варианта как добраться до монастыря: первый - сначала посетите пещерный город Чуфут-Кале, 
            до которого можно добраться на джипе, а после тропа, идущая вниз с горы, выведет вас к монастырю.`,
